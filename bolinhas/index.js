...
let larguraPalco = palco.offsetWidth //para pegar do css a largura
let alturaPalco = palco.offsetHeight // para pegar do css a altura
let bolas = []
let numBolas = 0

class Bola { // aqui sera definido o tamanho das bolinhas por tam, as cores, por r g e b e onde elas serão criadas, tanto em px e py, velocidade com velx e vely e direçaõ com dirx e diry
...
window.addEventListener("resize", (evt) => { //para redimensionar a tela
